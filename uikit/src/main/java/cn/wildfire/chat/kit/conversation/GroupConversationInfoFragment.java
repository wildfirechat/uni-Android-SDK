...
//        int duration = PTTClient.getInstance().getMaxSpeakTime(this.conversationInfo.conversation);
//        Log.e("test", "set t0 10" );
//        PTTClient.getInstance().setConversationMaxSpeakTime(this.conversationInfo.conversation, 10, new GeneralCallback() {
//            @Override
//            public void onSuccess() {
//                int d = PTTClient.getInstance().getMaxSpeakTime(conversationInfo.conversation);
//                Log.e("test", "xxx" + d);
//
//            }
//
...
//            }
//        });
        Log.e("test", "modify groupName to ooooo");
        ChatManager.Instance().modifyGroupInfo(this.conversationInfo.conversation.target, ModifyGroupInfoType.Modify_Group_Name, "noooo", Collections.singletonList(0), null, new GeneralCallback() {
            @Override
            public void onSuccess() {
                GroupInfo groupInfo = ChatManager.Instance().getGroupInfo(conversationInfo.conversation.target, false);
                Log.e("test", "modify success " + groupInfo.name);
            }
